...
@Repository("emailMsgDao")
@Transactional
public class EmailMsgDaoImpl extends AbstractDao<Integer, EmailMsg> implements EmailMsgDao {

	public EmailMsg findById(Integer id) {
		return getByKey(id.intValue());
	}

	@Override
	public void saveMsg(EmailMsg msg) {
	...
	@Override
	public void updateMsg(EmailMsg msg) {
