...
public interface AttendanceService {
	...
	ArrayList<Attendance> findAttendanceExt(Integer school_id,Integer class_id,Integer student_id,Integer from_row_id,int from_num, int max_result, String from_dt, String to_dt);
