...
//			body("messageObject",containsString("There are some students that were not filled score field.") );
//		
//	}
//	@Test
...
//			log().ifValidationFails().
//			assertThat()
//			.statusCode(HttpStatus.BAD_REQUEST.value()).body("messageObject",containsString("There are some classes that were not filled score field") );
//		
//	}
//	@Test
...
//		
//		param("class_ids", "1,2").
//		param("ex_key","m99999"). // Invalid ex_key
//		
//		when().get(path).
//		then().
//		log().ifValidationFails().
//		assertThat()
//		.statusCode(HttpStatus.BAD_REQUEST.value()).body("messageObject",containsString("ex_key is not existing") );
//		
//	}
//	@Test
...
//		header("auth_key", ADM1_AUTH_KEY). 
//		
//		param("class_ids", "20,21").  // class 20,,21 not belong to school 1
//		param("ex_key","m1").
//		
//		when().get(path).
//		then().
//		log().ifValidationFails().
//		assertThat()
//		.statusCode(HttpStatus.BAD_REQUEST.value()).body("messageObject",containsString("is not same with me.school_id") );
//		
//	}
//	
//	@Test
...
//		logger.info(method_name + " START");
//
//		String path = "/api/ranks";
//
//		given().
//			header("api_key", WEB_API_KEY).
//			header("auth_key", ADM1_AUTH_KEY).
//			
//			param("filter_student_id", "10,11").
...
//			
//			//param("filter_student_id", "10,11").
//			param("filter_class_id","999999").
//			param("filter_year_id","1").
//			param("order_ex_key","m1").
//			
//			when().get(path).then().log().ifValidationFails().
//		assertThat().statusCode(400).body("developerMessage", containsString("class_id is not existing"));
//		
//		
//	}
//	@Test
...
//			
//			when().get(path).then().log().ifValidationFails().
//		assertThat().statusCode(400).body("developerMessage", containsString("class.school_id != me.school_id"));
//		
//	}
//	@Test
...
//			header("auth_key", ADM1_AUTH_KEY).
//			
//			param("filter_student_id", "999").
//			param("filter_class_id","1").// class_id 20 not belong to school1
//			param("filter_year_id","1").
//			param("order_ex_key","m1").
//			
//			when().get(path).then().log().ifValidationFails().
...
//			header("auth_key", ADM1_AUTH_KEY).
//			
//			param("filter_student_id", "20"). // student 20 not belong to c lass 20
//			param("filter_class_id","1").
//			param("filter_year_id","1").
//			param("order_ex_key","m1").
//			
...
//					param("filter_class_id","1").
//					param("filter_year_id","20"). // year_id: 20 not exist
//					param("order_ex_key","m1").
//					
//					when().get(path).then().log().ifValidationFails().
...
//			param("filter_student_id", "10").
//			param("filter_class_id","1").
//			param("filter_year_id","2"). // year_id: 2 not 
//			param("order_ex_key","m1").
//			
//			when().get(path).then().log().ifValidationFails().
